...
<div>
      ...
      <div class="px-3 py-3 lg:px-5 lg:pl-3">
         <div class="flex items-center justify-between">
            <div class="flex items-center justify-start">
               ...
               <span class="px-2 py-1 rounded mx-2 bg-green-200 text-sm text-dark-900">Monitors Dashboard</span>
   ...
   <div class="flex overflow-hidden bg-white pt-32">
      <aside id="sidebar" class="fixed hidden z-20 h-full top-0 left-0 pt-32 flex lg:flex flex-shrink-0 flex-col w-64 transition-width duration-75" aria-label="Sidebar">
                  ...
                  <ul class="space-y-2 pb-2">
                     ...
                     <li>
                        <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           <i class="fa-duotone fa-users-rays"></i>
                           <span class="ml-3 flex-1 whitespace-nowrap">Suppliers</span>
                           <span class="bg-gray-200 text-gray-800 ml-3 text-sm font-medium inline-flex items-center justify-center px-2 rounded-full">50</span>
                        </a>
                     </li>
                     <li>
                        <a href="#" target="_blank" class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                           <i class="fa-duotone fa-users-line"></i>
                           <span class="ml-3 flex-1 whitespace-nowrap">Collectors</span>
